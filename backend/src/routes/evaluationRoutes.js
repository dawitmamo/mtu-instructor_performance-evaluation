...
import { hodEvaluationSchema, keyGenerationSchema, peerEvaluationSchema, studentEvaluationSchema } from '../validators/schemas.js';
import { generateEvaluationKeys, getEvaluationTemplate, listEvaluationTargets, studentEvaluationStatus, submitHodEvaluation, submitPeerEvaluation, submitStudentEvaluation } from '../controllers/evaluationController.js';
...
evaluationRoutes.post('/evaluation-keys/generate', authorize('HOD', 'COURSE_COMMITTEE', 'EXAM_COMMITTEE'), validate(keyGenerationSchema), audit('EVALUATION_KEYS_GENERATED'), generateEvaluationKeys);
