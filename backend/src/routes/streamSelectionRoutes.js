...
streamSelectionRoutes.get('/stream-selection/manage', authorize('HOD', 'EXAM_COMMITTEE'), getStreamSelectionManagement);
streamSelectionRoutes.post('/stream-selection/rounds', authorize('HOD', 'EXAM_COMMITTEE'), validate(streamSelectionRoundSchema), audit('STREAM_SELECTION_ROUND_SAVED'), saveStreamSelectionRound);
streamSelectionRoutes.post('/stream-selection/rounds/:id/allocate', authorize('HOD', 'EXAM_COMMITTEE'), audit('STREAMS_ALLOCATED'), allocateStreams);
